...
export const RIDDLE_REPLACEMENTS = Object.freeze([
  ...
  [/聽起來輕的那一步，帳從別處扣。?/g, "這一步做完，接下來可能發燒、挨打、被扣飯，或被人抓住把柄。"],
  [/聽起來輕。實際會扣時間、留下把柄，或讓你受傷。/g, "這件事看起來不費力。做完仍可能浪費半天、被人抓住把柄，或把人弄傷。"],
  [/舊傷在這個情境裡先發制人：好處變薄，身體先記得痛。/g, "舊傷口或舊巴掌一碰上類似的場面就先痛，原先能緩的一口氣沒了。"],
  [/舊傷先發制人/g, "舊傷口先痛起來"],
  [/好處變薄。?/g, "能換到的飯、藥或讓路變少了。"],
  [/名單先於你的解釋被打開。好處變薄。/g, "名冊先被打開，還沒輪到你解釋。能領的糧、能走的路變少了。"],
  [/處分紀錄在這個情境裡先被打開。好處變薄。/g, "處分紀錄先被拿出來給人看。這次能少挨的罰變少了。"],
  [/動盪讓普通也變薄。?/g, "街上一緊，沒人特別害你，也沒人記得讓路。"],
  [/字面像好處。帳會從健康、把柄或時間裡扣。/g, "看起來像占便宜。做完可能發燒、被人抓住把柄，或白白耗掉半天。"],
