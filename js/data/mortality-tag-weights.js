...
export const MORTALITY_TAG_WEIGHTS = Object.freeze([
  ...
  { tags: ["trauma_ptsd"], accident: 0.1, violence: 0.08, disease: 0.04 },
  { tags: ["trauma_melancholia"], disease: 0.14, accident: 0.08, hunger: 0.05, senescence: 0.06 },
  { tags: ["trauma_persecution"], accident: 0.08, violence: 0.1 },
  { tags: ["trauma_persona_crack"], violence: 0.12, accident: 0.08 },
  ...
  { tags: ["wealth_bankrupt"], hunger: 0.45, disease: 0.22, violence: 0.18, accident: 0.12 },
  { tags: ["wealth_indebted"], hunger: 0.16, violence: 0.1, disease: 0.06 },
  { tags: ["wealth_street"], hunger: 0.4, environment: 0.28, disease: 0.2, violence: 0.16 },
  { tags: ["wealth_bonded"], accident: 0.16, hunger: 0.12, disease: 0.08 },
  { tags: ["wealth_collectors"], violence: 0.32, accident: 0.1 },
  { tags: ["wealth_malnourished"], hunger: 0.5, disease: 0.22 },
  { tags: ["wealth_ruined_name"], violence: 0.12, accident: 0.06 },
  { tags: ["kin_orphan"], hunger: 0.28, disease: 0.16, violence: 0.12, accident: 0.1 },
  { tags: ["kin_grief"], disease: 0.1, accident: 0.08 },
  { tags: ["kin_abandoned"], hunger: 0.18, violence: 0.1, disease: 0.08 },
  { tags: ["kin_betrayed"], violence: 0.14, accident: 0.06 },
  { tags: ["kin_rival_hot"], violence: 0.28, accident: 0.1 },
  { tags: ["kin_widow"], disease: 0.12, accident: 0.08 },
  { tags: ["kin_estranged"], violence: 0.08, accident: 0.04 },
  { tags: ["acquired_class_fall"], hunger: 0.12, violence: 0.08 },
...
/** sanity 0 → 1.55× accident/disease, sanity 100 → 0.9×. Never a zero. Never cancels violence. */
export const SANITY_SURVIVAL_CURVE = Object.freeze({
  causes: ["accident", "disease", "hunger"],
  at0: 1.55,
  at100: 0.9,
});
