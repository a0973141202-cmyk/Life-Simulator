...
export const TAG_GLOSS = Object.freeze({
  ...
  persona_hardy: "田事與雜活先做完，少抱怨。",
  persona_cat_keeper: "巷口與簷下的貓他認得。",
  persona_loyal_friend: "同伴的事他記在心上。",
  persona_faithful: "答應過的人，不輕易換口風。",
  persona_gentle: "語氣不衝，少當面撕破臉。",
  persona_high_roller: "敢押大注，也認得出該停的時候。",
  persona_brotherhood: "朋友喊一聲，肯挺，不先算利害。",
  persona_principled: "底線寫死，不拿原則換一時面子。",
  persona_quit_ahead: "贏了就收，不戀戰到輸光。",
  persona_114514: "那串數字像班表，又像幻覺，寫進下北澤的傳說。",
  persona_beast_senpai: "野獸先輩氣場寫在走路的方式裏，巷口先認得他。",
  persona_shimokita_labor: "下北澤打工班表比官署更準時。",
  persona_natsumikan: "夏蜜柑的酸氣混進夜班與窄巷。",
  persona_stench_foul: "惡臭難聞的傳說壓不住，卻跟他的名字並排。",
  persona_onmad_classic: "定番音MAD 的迴圈把人吸進二次創作的歷史糾葛。",
  persona_aniki_wrestle: "兄貴摔角把力氣與義氣寫進同一記肩摔。",
  persona_deep_philosophy: "深邃哲學把困境看穿一截，身子仍站穩。",
  persona_forest_fairy: "森之妖精似的身影穿過夜色與次文化深處。",
  persona_loyal_bond: "重情重義：同伴低谷時不肯先鬆開。",
  persona_biochem: "Biochem：亞洲網路與桑拿房迴響的源頭傳說。",
  persona_banana_legend: "里約街頭認得這一身自由的節奏。",
  persona_absolute_freedom: "不拿自由換一時面子。",
  persona_meme_dancer: "舞步比口令先到，熱也不散。",
  persona_brazil_samba: "巴西森巴寫在腳步與笑聲裏。",
  persona_invincible_smile: "無敵笑容能把嚴肅教條先笑散。",
  父親在世: "父親在戶口剛寫上時仍在冊。",
  父親已故: "父親在你能記事前已不在。",
  母親在世: "母親在戶口剛寫上時仍在冊。",
  母親已故: "母親在你能記事前已不在。",
