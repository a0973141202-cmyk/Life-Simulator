...
export const TAG_GLOSS = Object.freeze({
  ...
  persona_shimokita_legend: "下北澤窄巷與地下街區認得他的名字。",
  persona_beast_instinct: "危機來時靠野性直覺判斷先動手或先逃。",
  persona_beast_senpai: "先輩氣場寫在走路的方式裏，巷口先認得他。",
  persona_stench: "那股壓不住的味與傳說一起跟在腳邊。",
  persona_athlete: "體育場練出的肺與腿比旁人更能扛。",
  persona_high_pressure: "高壓下還能做事，帳卻從精神先扣。",
  persona_abyss_magnet: "奇人怪事容易被吸進他的路。",
  persona_muscle_hunk: "力氣與身形撐得住勞動與衝突。",
  persona_wrestler: "摔角墊上練出的應對寫進危機時刻。",
  persona_aniki: "對同伴肯挺、肯喊，低谷裏先伸手。",
  persona_cheerful: "樂觀不散，時代壓也少先吞掉神智。",
  persona_born_leader: "人群裏自然有人跟他站到同一邊。",
  persona_banana_legend: "里約街頭認得這一身自由的節奏。",
  persona_absolute_freedom: "不拿自由換一時面子。",
  persona_meme_dancer: "舞步比口令先到，熱也不散。",
  persona_brazil_passion: "巴西的熱寫在走路與笑聲裏。",
  父親在世: "父親在戶口剛寫上時仍在冊。",
  父親已故: "父親在你能記事前已不在。",
  母親在世: "母親在戶口剛寫上時仍在冊。",
  母親已故: "母親在你能記事前已不在。",
